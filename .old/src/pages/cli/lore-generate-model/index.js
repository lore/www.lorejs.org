...
export default (props) => {
  return (
    <Template>
      ...
      <p>
        CLI command to add a <Link to="/models/">Model</Link>] to your project.
      </p>
      ...
      `}/>
      <p>
        The command above will generate a file located at <code>src/models/example.js</code> that looks like this:
      </p>
      <Markdown text={`
      export default {
