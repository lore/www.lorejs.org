...
export default (props) => {
  return (
    <Template
      ...
      description={(
        <p>
          Useful for providing the user with a clear indication that what they're looking for does not
          exist, as infinite loaders and blank pages are both poor user experiences.
        </p>
      )}
    >
      <h2>
