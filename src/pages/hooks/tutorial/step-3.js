...
export default (props) => {
  return (
    <Template>
      ...
      <p>
        With this change, we've now declared that we want to change the application interval of 5000 milliseconds to be
      ...
      <p>
        Next we're going to <Link to="../step-4/">implement the functionality of our hook</Link>.
      </p>
    </Template>
  )
};
