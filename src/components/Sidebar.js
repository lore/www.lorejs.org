...
const NavLink = (props) => (
  <li className="mb-3 lg:mb-1">
    <Link className={props.active ?
      "px-2 -mx-2 py-1 transition-fast relative block text-teal-600 font-medium" :
      "px-2 -mx-2 py-1 transition-fast relative block hover:translate-r-2px hover:text-gray-900 text-gray-600 font-medium"
    } to={props.href}>
      <span className={`rounded absolute inset-0 bg-teal-200 ${props.active ? 'opacity-25' : 'opacity-0'}`}></span>
        ...
        <nav id="nav" className="px-6 pt-6 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-(screen-16)">
          ...
          <div className="mb-10">
            {[
              ...
              ['/screencasts', 'Screencasts', <ScreencastsIcon/>],
