...
export default (props) => {
  return (
    <Template
      title="Models"
      subtitle="Docs for generating @lore/backbone Models from config files."
    >
      <h2>
        Purpose
      </h2>
      <p>
        ...
        this, we're going to use the <code>Model</code> concept from the <code>@lore/backbone</code> library,
      ...
      <p>
        Pretend you have a REST API that allows you to create, find, update, and delete posts. This
      ...
      <p>
        We can use a Model to interact with this API like thus:
      </p>
